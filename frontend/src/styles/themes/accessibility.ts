// Accessibility theme configuration for the dashboard
export const accessibilityTheme = {
  ...
  accessibility: {
    highContrast: {
      ...
      primary: '#000000', // Black for maximum contrast
    ...
    screenReader: {
      // Elements that should be hidden from sight but available to screen readers
      visuallyHidden: {
        position: 'absolute',
        width: '1px',
        height: '1px',
    ...
    focusIndicator: {
      style: 'outline', // Options: 'outline', 'border', 'shadow'
      thickness: '2px',
      color: '#2563eb', // Blue outline for focus
    },
  },
  animation: {
