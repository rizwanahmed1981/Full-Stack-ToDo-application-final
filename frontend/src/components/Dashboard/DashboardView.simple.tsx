    ...
    >
      ...
      {isLoading ? (
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          {/* Right Column - Just a placeholder instead of TaskDisplay for now */}
          <div className="lg:col-span-2">
            <Card className="bg-white/90 backdrop-blur-sm">
              <CardContent className="p-6">
                <h2 className="text-xl font-semibold mb-4">Tasks Placeholder</h2>
                <p>Task display would go here</p>
              </CardContent>
            </Card>
          </div>
        </div>
